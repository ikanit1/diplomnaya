    ...
    public class TaskDatabaseHelper extends SQLiteOpenHelper {
        ...
        private static final String COLUMN_TASK_CREATED = "task_created";
        ...
        public void addTask(Task task) {
            ...
            values.put(COLUMN_TASK_CREATED, task.getCreationTime());
        ...
        public List<Task> getAllTasks() {
            ...
            if (cursor != null) {
                while (cursor.moveToNext()) {
                    ...
                    task.setCreationTime(cursor.getString(cursor.getColumnIndex(COLUMN_TASK_CREATED)));
